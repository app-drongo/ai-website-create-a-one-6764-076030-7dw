...
// Generated: 2025-08-28T09:57:55.896Z
...
import { Menu, X, Anchor, Calendar } from "lucide-react"
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <Anchor className="size-4 text-background" />
              </div>
              <span className="font-bold text-xl text-foreground">Côte d'Azur Boat Rentals</span>
            </Link>
          </div>
